...
/// <summary>
/// Represents a validator for the <see cref="BlogRequestCreateModel"/> class.
/// </summary>
public class BlogRequestCreateModelValidator : AbstractValidator<BlogRequestCreateModel>
{
    /// <summary>
    ...
    /// </summary>
    public BlogRequestCreateModelValidator()
    {
        RuleFor(o => o.Title)
            .NotNull()
